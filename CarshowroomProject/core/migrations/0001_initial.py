    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_type', models.CharField(choices=[('petrol', 'petrol'), ('disel', 'disel'), ('CNG', 'CNG'), ('bio disel', 'bio_disel'), ('electric', 'electric')], default=core.models.FuelTypes['disel'], max_length=50)),
